...
class DagmanCreator(TaskAction):
    ...
    def prepareJobArguments(self, dagSpecs, info, task):
        ...
        for dagspec in dagSpecs:
            ...
            argDict['CRAB_ISB'] = info['cacheurl_flatten']  # 'https://cmsweb.cern.ch/crabcache'
            argDict['CRAB_JobSW'] = info['jobsw_flatten']  # 'CMSSW_9_2_5'
            argDict['CRAB_JobArch'] = info['jobarch_flatten']  # 'slc6_amd64_gcc530'
