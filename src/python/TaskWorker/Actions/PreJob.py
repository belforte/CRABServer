...
class PreJob:
    ...
    def pythonListToClassAdValue(self, aList):
    ...
    def alter_submit(self, crab_retry):
        ...
        if blackList:
            newJobSubmit['My.CRAB_SiteBlacklist'] = self.pythonListToClassAdValue(blackList)
        if whiteList:
            newJobSubmit['My.CRAB_SiteWhitelist'] = self.pythonListToClassAdValue(whiteList)
        if desiredSites:
            newJobSubmit['My.DESIRED_SITES'] = self.pythonListToClassAdValue(desiredSites)
        if dataLocations:
            newJobSubmit['My.DESIRED_CMSDataLocations'] = self.pythonListToClassAdValue(dataLocations)
